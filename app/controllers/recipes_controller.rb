class RecipesController < ApplicationController
  ...
  def index
    ...
    recipes = HTTP.get("https://api.spoonacular.com/recipes/findByIngredients?ingredients=#{query}&number=6&sort=max-used-ingredients&apiKey=#{Rails.application.credentials.spoonacular_api_key}&visualizeRecipe")
